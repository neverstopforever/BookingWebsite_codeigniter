		...
		<div class="modal fade delete-modal" id="approveModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		        ...
		        <p style="text-align: center;"><center><h4>Do you want to confirm this booking?</h4></center></p>
		        <div class="col-md-3 col-md-offset-3">
			        <a href="<?php echo $this->config->base_url();?>booking_content/staff_update_booking_content/Conformed" class="btn btn-default" id="approved">YES</a>
			      </div>
		        <div class="col-md-3">
		    ...
		    <div class="modal-content">
		      <div class="modal-body">
		        ...
		        <div class="col-md-4 col-md-offset-2">
			        <a href="<?php echo $this->config->base_url();?>booking_content/staff_update_booking_content/Cancelled" id="cancel" class="btn btn-default">YES, DELETE</a>
			      </div>
		        <div class="col-md-4">
