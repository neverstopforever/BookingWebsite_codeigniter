		...
		<div class="content twocols page11">
			<div class="row">
				...
				<div class="col-md-8 col-sm-6 col-xs-12">
					...
					<form class="form-horizontal form-edit" style="background:url(<?php echo $this->config->base_url(); ?>r/img/bg_pattern.png);  padding:20px 40px;" method="post" action="<?php echo $this->config->base_url()?>booking_content/resident_save_booking_content">
						...
						<div class="row">
							<div class="col-md-4">
								...
								<input type="text" name = "name" value="<?php echo $user_data->username;?>" class="form-control" id="inputSender" placeholder="" readonly>
							</div>
							<div class="col-md-4">
								<label for="inputSender" class="control-label">RESIDENT BLOCK</label>
								<input type="text" name="desident_block" value="<?php echo $user_data->block;?>" class="form-control" id="inputSender" placeholder="" readonly>
							</div>
							<div class="col-md-3">
								<label for="inputSender" class="control-label">RESIDENT UNIT</label>
								<input type="text" name="desident_unit" value="<?php echo $user_data->unit;?>"class="form-control" id="inputSender" placeholder="" readonly>
							</div>
						</div>
						<div class="row">
							<div class="col-md-4">
								<label for="inputSender" class="control-label">RESIDENT EMAIL*</label>
								<input type="text" name="desident_email" value="<?php echo $user_data->email;?>" class="form-control" id="inputSender" placeholder="" readonly>
							</div>
							<div class="col-md-4">
								<label for="inputSender" class="control-label">RESIDENT CONTACT NUMBER</label>
								<input type="text" name="desident_number" value="<?php echo $user_data->contact_no;?>" class="form-control" id="inputSender" placeholder="" readonly>
							</div>
						</div>
						<div class="row">
							<div class="col-md-12">
