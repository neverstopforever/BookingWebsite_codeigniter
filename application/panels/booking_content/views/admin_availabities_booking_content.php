		...
		<div class="content twocols page11">
			<div class="row">
				...
				<div class="col-md-8 col-sm-6 col-xs-12">
					...
					<form class="form-horizontal form-edit" style="background:url(<?php echo $this->config->base_url(); ?>r/img/bg_pattern.png); padding:20px 40px;" method="post" action="<?php echo $this->config->base_url()?>booking_content/admin_save_booking_content">
