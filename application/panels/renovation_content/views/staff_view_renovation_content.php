			...
			<div class="row">
				...
				<div class="table-elements">
					...
					<div class="table-responsive booking-details">
						  <a class="btn add-new-guest" href="<?php echo $this->config->base_url(); ?>renovation/add">ADD NEW RENOVATION</a>	
							...
							<?php foreach ($view_renovation as $key => $value): ?>
								<tr>
									...
									<td class="col7 tleft">
										...
										<a class="open-AddBookDialog-cancel delete" data-id="<?php echo $value->renovation_id; ?>" data-title="Delete" data-toggle="modal" data-target="#cancelModal" ><img src="<?php echo $this->config->base_url(); ?>r/img/icon-delete-on.png"></a>
									</td>
								</tr>
		    ...
		    <div class="modal-content">
		      <div class="modal-body">
		        ...
		        <div class="col-md-4 col-md-offset-2">
		            <a href="<?php echo $this->config->base_url();?>renovation_content/staff_delete_renovation_content" id="cancel" class="btn btn-default">YES, DELETE</a>
			    </div>
		        <div class="col-md-4">
		...
		<div class="modal fade ViewGuest" tabindex="-1" role="dialog" aria-labelledby="ViewGuestLabel" id="viewguest" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal" method="post" id="renovation_add" action="<?php echo $this->config->base_url(); ?>renovation_content/staff_renovation_update" >
...
<script>
	...
	var renovation_id = $(this).data('id');
    	$.ajax({
	    	type: 'GET',
	    	async: false,
	    	url: base_url+"renovation_content/renovation_content/staff_get_renovation_record?renovation_id="+renovation_id,
	    	cache: false,
