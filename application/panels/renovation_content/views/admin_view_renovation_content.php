		...
		<div class="modal fade ViewGuest" tabindex="-1" role="dialog" aria-labelledby="ViewGuestLabel" id="viewguest" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal" method="post" id="renovation_add" action="<?php echo $this->config->base_url(); ?>renovation_content/admin_renovation_update" >
...
<script>
	...
	var renovation_id = $(this).data('id');
    	$.ajax({
	    	type: 'GET',
	    	async: false,
	    	url: base_url+"renovation_content/renovation_content/admin_get_renovation_record?renovation_id="+renovation_id,
	    	cache: false,
