			...
			<div class="row">
				...
				<form class="form-inline">
					...
					<div class="table-responsive booking-details guard-table">
						<table id="users_table" class="table table-striped">	<thead>
								<tr>
		    ...
		    <div class="modal-content">
		      <div class="modal-body">
		        ...
		        <div class="col-md-4 col-md-offset-2">
		            <a href="<?php echo $this->config->base_url();?>renovation_content/resident_delete_renovation_content" id="cancel" class="btn btn-default">YES, DELETE</a>
			    </div>
		        <div class="col-md-4">
		...
		<div class="modal fade ViewGuest" tabindex="-1" role="dialog" aria-labelledby="ViewGuestLabel" id="viewguest" aria-hidden="true">
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						<form class="form-horizontal" method="post" id="renovation_add" action="<?php echo $this->config->base_url(); ?>renovation_content/resident_renovation_update" >
...
<script>
	...
	var renovation_id = $(this).data('id');
    	$.ajax({
	    	type: 'GET',
	    	async: false,
	    	url: base_url+"renovation_content/renovation_content/resident_get_renovation_record?renovation_id="+renovation_id,
	    	cache: false,
