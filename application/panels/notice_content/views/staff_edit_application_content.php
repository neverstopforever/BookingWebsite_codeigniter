    ...
    <div class="content">
	  <div class="row">
	    ...
	    <div class="container-fluid form-upload">
		  ...
		  <a class="back-to-app-form" href="<?php echo $this->config->base_url();?>notice/view">Back to Application Forms</a>
		  
		  <form class="form-horizontal" method="post" action="<?php echo $this->config->base_url();?>notice_content/staff_update_application_content"  enctype="multipart/form-data">
		    <div class="form-group current-file">
			  ...
			  <div class="the-current-file"><span class="the-file"><?php echo $edit_application[0]->doc_name ?></span> <span class="file-size">(175 Kb)</span></div>
			   <input type="hidden" name="file_id"value="<?php echo $edit_application[0]->fileid ?>" class="form-control">
