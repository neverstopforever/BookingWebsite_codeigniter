    ...
    <div class="content">
	  ...
	  <div class="row">
	    ...
	    <div class="container-fluid form-download-header">
		  <span><b>Notices & CIRCULARS</b></span>
	    </div>
		<div class="right scrolable">
			<?php 
			if(isset($view_application[0]->file_name)){
			?>
    		<img id="show_img" src="<?php echo $this->config->base_url();?>application_form/<?php echo $view_application[0]->file_name?>"/>
			<?php } ?>
		</div> 
		<div class="container-fluid form-download-detail">
		  ...
		  <ul class="list-group">
		   <?php 
			   ...
			   ?>
			   <li class="list-group-item"><a href="<?php echo $this->config->base_url();?>notice_content/admin_view_download_application/<?php echo $value->full_path?>"> <?php echo $value->doc_name?></a>
			   <div class="right">
			   	<a class="view_img" href="#" id="<?php echo str_replace(".", "_thumb.", $value->file_name)?>"> view</a>
			   </div>
			   </li>
