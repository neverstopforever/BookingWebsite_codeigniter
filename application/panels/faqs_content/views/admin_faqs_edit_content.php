		...
		<div class="content-edit">
			<div class="row">
				...
				<div class="container-fluid">
					...
					<form id = "user_add"class="form-horizontal" method="post" action="<?php echo $this->config->base_url();?>faqs_content/admin_faqs_update_content">
					
				   	<div class="row">
				   <span style="font-size:18px"><strong>Update Category</strong></span><br />
					<div class="col-md-8 ">
							<div class="col-sm-6">
							<label for="inputResidentName" class="col-sm-6 control-label">Category Name</label>
								<input type="text" class="form-control" name="name" id="name" placeholder="name.." value="<?php echo $info[0]->cat_name;?>"/>
