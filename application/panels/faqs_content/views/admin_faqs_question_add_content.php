		...
		<div class="content-edit">
			<div class="row">
				...
				<div class="container-fluid">
					...
					<form id = "user_add"class="form-horizontal" method="post" action="<?php echo $this->config->base_url();?>faqs_content/admin_faqs_question_save_content">
				   ...
				   <span style="font-size:18px"><strong>Add Category</strong></span><br />
					<div class="col-md-8 ">
							...
							<label for="inputResidentName" class="col-sm-6 control-label">Question</label>
								<textarea type="text" class="form-control" name="name" id="name" placeholder="Question.." ></textarea>
								<input type="hidden" class="form-control" name="cat_id" id="cat_id" placeholder="name.." value="<?php echo $this->uri->segment(3);?>"/>
							</div>
					...
					<div class="col-md-8 ">
							...
							<label for="inputResidentName" class="col-sm-6 control-label">Awnser</label>
								<textarea type="text" class="form-control" name="awnser" id="awnser" placeholder="Awnser.."></textarea>
							</div>
