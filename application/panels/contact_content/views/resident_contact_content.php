		...
		<div class="content-edit">
				...
				<?php		
				 ...
				 ?>
					...
					<form id = "user_add"class="form-horizontal" method="post" action="<?php echo $this->config->base_url();?>contact_content/resident_add_contact">
					<div class="row">
						<div class="col-md-6">
							<label for="inputResidentName" class="col-sm-3 control-label">Contact Us</label>
							<div class="col-sm-7">
