		    ...
		    <div class="modal-content">
		      <div class="modal-body">
		        ...
		        <div class="col-md-4 col-md-offset-2">
		            <a href="<?php echo $this->config->base_url();?>guest_content/resident_delete_guest_content" id="cancel" class="btn btn-default">YES, DELETE</a>
			      </div>
		        <div class="col-md-4">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form class="form-horizontal" id="user_update" method="post" action="<?php echo $this->config->base_url()?>guest_content/resident_guest_update">
...
<script>
	...
	var visitor_id = $(this).data('id');
    	$.ajax({
	    	type: 'GET',
	    	async: false,
	    	url: base_url+"guest_content/guest_content/resident_get_guest_record?visitor_id="+visitor_id,
	    	cache: false,
