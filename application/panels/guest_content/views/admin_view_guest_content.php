	    ...
	    <div class="container-fluid app-form">
		  <form class="form-inline">
			...
			<div class="table-responsive">
					  <a class="btn upload-new-form" href="<?php echo $this->config->base_url();?>guest/add">ADD NEW GUEST</a>	
			  ...
			  <table id="users_table"class="table table-striped">
				...
				<tbody>
				 ...
				 <tr>
						...
						<a class="open-AddBookDialog-cancel" data-id="<?php echo $value->visitor_id?>" data-title="Delete" data-toggle="modal" data-target="#cancelModal" ><img src="<?php echo $this->config->base_url();?>r/img/icon-delete-on.png"></button>
						</td>
				 </tr>
		    ...
		    <div class="modal-content">
		      <div class="modal-body">
		        ...
		        <div class="col-md-4 col-md-offset-2">
		            <a href="<?php echo $this->config->base_url();?>guest_content/admin_delete_guest_content" id="cancel" class="btn btn-default">YES, DELETE</a>
			      </div>
		        <div class="col-md-2">
			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form class="form-horizontal" id="user_update" method="post" action="<?php echo $this->config->base_url()?>guest_content/admin_guest_update">
						  ...
						  <!-- <div class="form-group">
							...
							<div class="col-sm-8">
							  <input type="text" class="form-control" id="resident_name" name="resident_name" placeholder="">
							</div>
						  </div> -->
						  <div class="form-group">
...
<script>
	...
	var visitor_id = $(this).data('id');
    	$.ajax({
	    	type: 'GET',
	    	async: false,
	    	url: base_url+"guest_content/guest_content/admin_get_guest_record?visitor_id="+visitor_id,
	    	cache: false,
