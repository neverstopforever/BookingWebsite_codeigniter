			...
			<div class="modal-dialog">
				<div class="modal-content">
					...
					<div class="modal-body">
						...
						<form class="form-horizontal" id="user_update" method="post" action="<?php echo $this->config->base_url()?>guest_content/staff_guest_update">
...
<script>
	...
	var visitor_id = $(this).data('id');
    	$.ajax({
	    	type: 'GET',
	    	async: false,
	    	url: base_url+"guest_content/guest_content/staff_get_guest_record?visitor_id="+visitor_id,
	    	cache: false,
