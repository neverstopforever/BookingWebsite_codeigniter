  ...
  <div class="content-edit">
			<div class="row">
				<div class="container-fluid">
					...
					<form id="user_update" class="form-horizontal" method="post" action="<?php echo $this->config->base_url();?>guest_content/admin_add_guest">
					<div class="row">
						<div class="col-md-6">
							...
							<!-- <label for="inputResidentName" class="col-sm-3 control-label">RESIDENT NAME</label>
							<div class="col-sm-7">
							...
							<div class="col-sm-4">
								<input type="text" class="form-control" id="resident_unit_no" name="resident_unit_no" placeholder="">
							</div>
						</div>
						<div class="col-md-6">
