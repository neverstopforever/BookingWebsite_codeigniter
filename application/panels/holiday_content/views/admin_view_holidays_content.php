					...
					<div class="table-responsive booking-details">
						...
						<table id="users_table" class="table table-striped">
							...
							<tbody>
								...
								?>
								<tr>
									<td class="col1"><?php echo $value->holiday_date?></td>
									<td class="col2"><?php echo $value->public_holiday?></td>
										<td class="col3 nobg">
										
										<a class="open-AddBookDialog-approved remove-underline" data-id="<?php echo $value->holidayid?>" data-title="Delete" data-toggle="modal" data-target="#editModal" ><img src="<?php echo $this->config->base_url();?>r/img/icon-pencil-on.png"></a>
										<a class="open-AddBookDialog-cancel" data-id="<?php echo $value->holidayid?>" data-title="Delete" data-toggle="modal" data-target="#cancelModal" ><img src="<?php echo $this->config->base_url();?>r/img/icon-delete-on.png"></a>
									</td>
								</tr>
								<?php
								} ?>
...
<!--						<a class="btn add-new-guest export pull-right" href="#" style="margin-right:185px; width: 160px;">EXPORT</a>-->
		...
		<div class="modal fade" id="approveModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		    	...
		    	<form id="holiday_add" class="form-inline" method="post" action="<?php echo $this->config->base_url();?>holiday_content/admin_holiday_add_content">
		    	<br><br>	
		        <div class="col-md-12">
		...
		<div class="modal fade delete-modal" id="cancelModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		    ...
		    <div class="modal-content">
		      <div class="modal-body">
		        ...
		        <div class="col-md-4 col-md-offset-2">
			        <a href="<?php echo $this->config->base_url();?>holiday_content/admin_delete_holiday_content" id="cancel" class="btn btn-default">YES, DELETE</a>
			      </div>
		        <div class="col-md-4">
		  ...
		  <div class="modal-dialog" role="document">
		    <div class="modal-content">
		    	<div class="modal-body">
		    	<form id="holiday_edit" class="form-inline" method="post" action="<?php echo $this->config->base_url();?>holiday_content/admin_holiday_update_content">
...
//    	
	...
	if(orgid!=''){
		$.ajax({
	    	type: 'GET',
	    	async: false,
	    	url: base_url+"holiday_content/holiday_content/admin_get_holiday_data?holiday_id="+orgid,
	    	cache: false,
