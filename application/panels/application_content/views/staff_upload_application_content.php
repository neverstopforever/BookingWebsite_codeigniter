    ...
    <div class="content">
	  <div class="row">
	    ...
	    <div class="container-fluid form-upload">
		  ...
		  <form class="form-horizontal" method="post" action="<?php echo $this->config->base_url();?>application_content/staff_save_application_content"  enctype="multipart/form-data">
