    ...
    <div class="content">
	  <div class="row">
	    ...
	    <div class="container-fluid form-upload">
		  ...
		  <form class="form-horizontal" method="post" action="<?php echo $this->config->base_url();?>application_content/admin_save_application_content"  enctype="multipart/form-data">
		  
		    <!-- <div class="form-group current-file">
			  <div class="control-label">CURRENT FILE</div>
			  <div class="the-current-file"><span class="the-file">admin-rules.txt</span> <span class="file-size">(175 Kb)</span></div>
			  <a href="#" class="delete-current-file">delete</a>
			</div> -->
