		...
		<div class="container-fluid form-download-detail">
		  ...
		  <ul class="list-group">
		   ...
		   foreach ($view_application as $key => $value) {
			   ?>
			   <li class="list-group-item"><a href="<?php echo $this->config->base_url();?>application_content/guard_view_download_application/<?php echo $value->full_path?>"> <?php echo $value->doc_name?></a></li>
