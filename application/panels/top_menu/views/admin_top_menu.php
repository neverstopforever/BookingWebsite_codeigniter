				...
				<div class="row">	
					...
					<ul class="nav navbar-nav">
						...
						<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li>
									<a href="<?php echo $this->config->base_url();?>guest/view">GUEST LIST</a>
								</li>
								<li class="divider"></li>
								<li>
									<a href="<?php echo $this->config->base_url();?>renovation/view">RENOVATION LIST</a>
						...
						<li class="dropdown active">
							<a href="<?php echo $this->config->base_url();?>application/download">
								APPLICATION FORMS
							</a>
