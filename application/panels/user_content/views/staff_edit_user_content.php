		...
		<div class="content-edit">
			<div class="row">
				<div class="container-fluid">
					...
					<form id = "user_add"class="form-horizontal" method="post" action="<?php echo $this->config->base_url();?>user_content/staff_update_user_content/<?php echo $edit_user[0]->userid; ?>">
					<div class="row">
						<div class="col-md-6">
